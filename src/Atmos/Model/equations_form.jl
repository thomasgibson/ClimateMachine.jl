...
two_point_flux(var::AbstractPrognosticVariable,
               td::TendencyDef{Flux{FirstOrder}},
               atmos::AtmosModel,
               args) = two_point_flux(atmos.equations_form, var, td, atmos, args)
...
function two_point_flux(::CentralSplitForm,
  ...
  args1 = merge(_args1, (precomputed = precompute(atmos, _args1, Flux{FirstOrder}()),))
  flux1 = flux(var, td, atmos, args1)

  _args2 = (state=state2, aux=aux2)
  args2 = merge(_args2, (precomputed = precompute(atmos, _args2, Flux{FirstOrder}()),))
